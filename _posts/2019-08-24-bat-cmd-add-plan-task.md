...
![](/assets/img/2019/08/20190825165833.png)
...
```shell
@echo off
schtasks  /create  /tn  testschtask /tr  C:\Soft\Vcp服务\job.vbs  /sc MINUTE /mo 6
java -jar C:\Soft\Vcp服务\vcp-service-1.2.jar -t 0
pause
```

计划任务隐藏窗口后台执行，job.vbs

```shell
Set ws = CreateObject("Wscript.Shell")
ws.run "cmd /C C:\Soft\Vcp服务\job.bat",vbhide 
```
